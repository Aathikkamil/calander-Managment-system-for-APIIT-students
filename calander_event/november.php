...
$get_holliday = curl_init();
    curl_setopt($get_holliday, CURLOPT_URL,"http://veenph.api.ones.lk/engine/api.php?day=2021-11-04&hashID=70c237693d072562e1ffad0f781b45c5");
...
$get_holliday1 = curl_init();
    curl_setopt($get_holliday1, CURLOPT_URL,"http://veenph.api.ones.lk/engine/api.php?day=2021-11-18&hashID=70c237693d072562e1ffad0f781b45c5");
